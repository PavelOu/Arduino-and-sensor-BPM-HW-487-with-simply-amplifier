...
String sketchName = "Arduino_Nano_Bpm_HW_487_en_6";
...
void loop() {
  if (menuOn == true) {
    ...
    Serial.println("G=yellow led test, H=red led test, J=analogInput and uMap info,");
    Serial.println("P or R=read parameters, S=Stop of data transfer,");
    Serial.println("U=0 normal 1=inverted data, V=0 to 7 analog pin !");
    Serial.println();
    Serial.println("Data On :");
    Serial.print("*I=Slave Number,");
    Serial.print(slaveNumber);
    Serial.println(",#,");
    Serial.print("*J=analogInput,uMap,");
  ...
  if (Serial.available()) {
    ...
    if (markRx == 86)  // V = analogPi 0 to 7
    {
      ...
      switch (analogInput) 
       {
        case 0:
        analogInput = analogPinA0;
        break;
      case 1:
        analogInput = analogPinA1;
        break;
      case 2:
        analogInput = analogPinA2;
        break;
      case 3:
        analogInput = analogPinA3;
        break;
      case 4:
        analogInput = analogPinA4;
        break;
      case 5:
        analogInput = analogPinA5;
        break;
      case 6:
        analogInput = analogPinA6;
        break;
      case 7:
        analogInput = analogPinA7;
        break;
